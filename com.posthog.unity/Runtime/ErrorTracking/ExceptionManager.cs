...
namespace PostHog.ErrorTracking
{
    ...
    internal sealed class ExceptionManager
    {
        ...
        private readonly Action<string, Dictionary<string, object>> _captureEvent;
        private readonly Func<string> _getDistinctId;

        private UnityExceptionIntegration _exceptionIntegration;
        private WebGLExceptionIntegration _webglIntegration;
        ...
        private void OnWebGLException(string message, string stackTrace)
        {
            if (!_isEnabled)
            {
                return;
        ...
        private void CaptureExceptionFromLog(string message, string stackTrace, bool handled)
        {
            try
            {
