...
- 8e372a5: Replace placeholder ErrorTracking asset GUIDs to prevent collisions with other Unity packages.

## 1.1.0

### Minor Changes

- 0639b2e: Add a beforeSend callback for modifying or dropping fully enriched events.
